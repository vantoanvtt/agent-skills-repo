...
description: REST API conventions — HTTP semantics, status codes, versioning, pagination, and OpenAPI standards applicable to any framework.
metadata:
  labels: [api-design, rest, openapi, versioning, pagination]
  triggers:
    files:
      [
        '**/*.controller.ts',
